...
class ProbateListSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('tx_hash', 'mails_array', 'owner_mail')
...
class ProbateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('address', 'tx_hash', 'name', 'mails_array', 'owner_mail', 'test_node')
    ...
    def update(self, instance, validated_data):
        ...
        instance.mails_array = validated_data.get('mails_array', instance.mails_array)
